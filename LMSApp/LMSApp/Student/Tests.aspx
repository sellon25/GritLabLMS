<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/LMSBoard.Master" CodeBehind="Tests.aspx.vb" Inherits="LMSApp.Tests" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Main_ContentPlaceHolder" runat="server">
    <div class="row" id="CoursesContainer1" runat="server">

    </div>
   <!--<div class="row" id="CoursesContainer" runat="server">

<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/LMSBoardAdmin.Master" CodeBehind="AnnouncementsKingsmen.aspx.vb" Inherits="LMSApp.AnnouncementsKingsmen" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Type_pageTitle" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Change_Breadcrumb_PageTitle" runat="server">
    Kingsmen Announcements
</asp:Content>
                ...
                <div style="height:500px; overflow-y: scroll;">
                    ...
                    <div class="d-flex flex-row comment-row p-3 mt-0">
                        ...
                        <div class="comment-text ps-2 ps-md-3 w-100">
                            ...
                            <span class="mb-3 d-block">Friday 22 June 2024</span>

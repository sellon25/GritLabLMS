<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/LMSBoardAdmin.Master" CodeBehind="MBKAAnnoucements.aspx.vb" Inherits="LMSApp.MBKAAnnoucements" %>
                    ...
                    <div style="height:500px; overflow-y: scroll;">
                        ...
                        <div class="d-flex flex-row comment-row p-3 mt-0">
                            ...
                            <div class="comment-text ps-2 ps-md-3 w-100">
                                <h5 class="font-medium">Mini banking</h5>
                                <span class="mb-3 d-block">ARRIVAL TIME</span>
                        ...
                        <div class="d-flex flex-row comment-row p-3 mt-0">
                            ...
                            <div class="comment-text ps-2 ps-md-3 w-100">
                                <h5 class="font-medium">Mini banking</h5>
                                <span class="mb-3 d-block">VENUE GL-00013</span>
                                <span class="mb-3 d-block">Lorem Ipsum is simply dummy text of the printing and type setting industry.It has survived not only </span>
                                    <div class="text-muted fs-2 ms-auto mt-2 mt-md-0">April 14, 2021</div>
                                </div>
                            </div>
                        ...
                        <div class="d-flex flex-row comment-row p-3 mt-0">
                            ...
                            <div class="comment-text ps-2 ps-md-3 w-100">
                                <h5 class="font-medium">Mini Banking</h5>
                                <span class="mb-3 d-block">DUE DATE CHANGED</span>

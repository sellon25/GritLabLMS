...
<asp:Content ID="Content3" ContentPlaceHolderID="Main_ContentPlaceHolder" runat="server">
    ...
    <div class="row">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4">
                    <label>&nbsp;</label><br>
                    <button type="button" class="btn btn-primary btn-outline-dark" onclick="applyFilter()">Apply Filter</button>
                    <button type="button" class="btn btn-secondary btn-outline-dark" onclick="resetFilter()">Reset</button>
                </div>
            </div>
